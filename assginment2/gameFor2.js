...
var playersNum = parseFloat(readlineSync.question("Would you like to play a game for one player or game for two?"));
// validity check
...
if (playersNum == 2)
{
    var player1 = (readlineSync.question("player 1 please enter your name: ")).toString();
    var player2 = (readlineSync.question("player 2 please enter your name: ")).toString();
    var player1sMoney = 50;
    var player2sMoney = 50;
}
else
{
    var player1 = (readlineSync.question("player 1 please enter your name: ")).toString();
