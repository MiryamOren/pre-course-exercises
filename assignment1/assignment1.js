...
if (hogwartsHouses[0] == 0 &
    hogwartsHouses[1] == 0 &
    hogwartsHouses[2] == 0 &
    hogwartsHouses[3] == 0)
{
    throw("No choice has been made, so we will not be able to determine which house you belong to. Try again");
}
